...
class UserAuthMiddle(MiddlewareMixin):
    ...
    def process_request(self, request):
        # 需要登录验证,个人中心和购物车
        need_login = ['/shopping/mine/', '/shopping/addCart/', '/shopping/subCart/',
                      '/shopping/cart/', '/shopping/generate_order/', '/shopping/orderWaitPay/',
                      '/shopping/orderpayed/', '/shopping/waitPayToPayed/',
                      '/shopping/changeCartAllSelect/', '/shopping/countPrice/']
